...
void PR3DCluster::dQ_dx_fit(double flash_time){
  ...
  // reco_pos.z += 1.5*units::mm;
  // reco_pos.y -= 1.5*units::mm;
  // reco_pos.x =  (reco_pos.x+0.1101*units::cm*2)/1.1009999*1.098 - 0.6*units::cm;
  ...
  // T U, V, W, wires ...
  std::cout << offset_t + slope_xt * reco_pos.x  << std::endl;
  std::cout << offset_u + (slope_yu * reco_pos.y + slope_zu * reco_pos.z) << std::endl;
  std::cout << offset_v + (slope_yv * reco_pos.y + slope_zv * reco_pos.z) + 2400 << std::endl;
  std::cout << offset_w + (slope_yw * reco_pos.y + slope_zw * reco_pos.z) + 4800 << std::endl;
