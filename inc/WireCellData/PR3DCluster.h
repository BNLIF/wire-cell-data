...
namespace WireCell{
  ...
  public:
    ...
    void fill_2d_charge(std::map<int,std::map<const GeomWire*, SMGCSelection > >& global_wc_map, std::map<std::pair<int,int>,std::pair<double, double> >& map_2D_ut_charge, std::map<std::pair<int,int>, std::pair<double, double> >& map_2D_vt_charge, std::map<std::pair<int,int>, std::pair<double, double> >& map_2D_wt_charge);
    
    void form_map_graph_based(std::vector<WCPointCloud<double>::WCPoint>& path_wcps_vec, std::map<std::pair<int,int>,std::pair<double,double> >& map_2D_ut_charge, std::map<std::pair<int,int>,std::pair<double,double> >& map_2D_vt_charge, std::map<std::pair<int,int>,std::pair<double,double> >& map_2D_wt_charge, std::map<int,std::set<std::pair<int,int>>>& map_3D_2DU_set, std::map<int,std::set<std::pair<int,int>>>& map_3D_2DV_set, std::map<int,std::set<std::pair<int,int>>>& map_3D_2DW_set, std::map<std::pair<int,int>,std::set<int>>& map_2DU_3D_set, std::map<std::pair<int,int>,std::set<int>>& map_2DV_3D_set, std::map<std::pair<int,int>,std::set<int>>& map_2DW_3D_set, double end_point_factor=0.6, double mid_point_factor=0.9, int nlevel = 3, double time_cut = 3);
    ...
    void trajectory_fit(PointVector& ps_vec, std::map<int,std::set<std::pair<int,int>>>& map_3D_2DU_set, std::map<int,std::set<std::pair<int,int>>>& map_3D_2DV_set, std::map<int,std::set<std::pair<int,int>>>& map_3D_2DW_set, std::map<std::pair<int,int>,std::set<int>>& map_2DU_3D_set, std::map<std::pair<int,int>,std::set<int>>& map_2DV_3D_set, std::map<std::pair<int,int>,std::set<int>>& map_2DW_3D_set,std::map<std::pair<int,int>, std::pair<double, double> >& map_2D_ut_charge, std::map<std::pair<int,int>, std::pair<double, double> >& map_2D_vt_charge, std::map<std::pair<int,int>,std::pair<double, double> >& map_2D_wt_charge, int flag_lambda=0, double init_lambda=0, int flag_scaling = 1);
